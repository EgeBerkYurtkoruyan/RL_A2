...
class Trainer_ActorCritic:
    def __init__(self, env_name, PolicyClass, ValueClass, config_file, results_path="results", advantage:bool=False):
    ...
    def train_actor_critic(self, l_rate=None, max_steps=None, gamma=None, n=None, avg_window=None):
        ...
        print("Initializing Policty and Value model for Actor-Critic")
        ...
        pbar = tqdm(total=max_steps, desc="Actor-Critic Progress")
